    ...
    return (
      <form onSubmit={(e) => this.handleSubmit(e)}>
        ...
        <label htmlFor="surname">Surname:</label>
          <input type="text" name="surname" value={fields.surname} onCHange={(e) => this.handleChange(e)}/>
        </div>
        <div>
        ...
        <label htmlFor="birthday">Birthday:</label>
          <input type="text" name="birthday" value={fields.birthday} onCHange={(e) => this.handleChange(e)}/>
        </div>
        <div>
        <label htmlFor="phone_number">Phone number:</label>
          <input type="text" name="phone_number" value={fields.phone_number} onCHange={(e) => this.handleChange(e)}/>
        </div>
